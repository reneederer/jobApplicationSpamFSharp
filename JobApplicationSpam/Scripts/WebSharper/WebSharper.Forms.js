(function()
{
 ...
 Collection.New=Runtime.Ctor(function(p,inits,adder)
 {
  ...
  this.adder=adder;
  this.arr=[];
  this["var"]=Var.Create$1(this.arr);
  ...
  this.changesView=View$1.Bind(function(arr)
  {
   ...
   {
    var x$1;
    x$1=Global.Array.prototype.slice.call(arguments);
